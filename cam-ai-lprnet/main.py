...
from detector import RKNNLPRNetDetector
...
class EdgeAIWorker:
    """Orchestrates GStreamer capture, LPRNet inference, and MQTT telemetry."""
    ...
    def start(self):
        ...
        logger.info("==================================================")
        logger.info("Starting RK3588 Edge AI Worker (LPRNet)...")
        ...
        # 1. Initialize detector backend (LPRNet)
        self.detector = RKNNLPRNetDetector()
    ...
    def _inference_worker_loop(self):
        ...
        while not self.stop_event.is_set():
            try:
                ...
                result = self.detector.detect(frame, Config.CONF_THRESHOLD)
